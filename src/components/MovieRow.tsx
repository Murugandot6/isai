...
export const MovieRow: React.FC<MovieRowProps> = ({ title, movies, onPlay }) => {
  ...
  const checkScrollPosition = () => {
    if (rowRef.current) {
      ...
      // Allow minor offset leeway for floating point inaccuracies
  ...
  return (
    <div className="space-y-4 mb-10 text-left relative group/row">
      ...
      {/* Scrollable Container wrapper with arrow controls overlay */}
      <div className="relative w-full">
        ...
        <div 
          ref={rowRef}
          className="flex gap-4 sm:gap-6 overflow-x-auto pb-4 pt-1 px-1"
          style={{
            scrollbarWidth: 'none',
