...
import { albumImage as defaultAlbumImage } from '../../assets/images'; // Using albumImage as a generic placeholder for genres
    ...
    >
      ...
      <div className="relative flex-1">
        <img 
          ...
          ref={imageRef} 
          onLoad={onLoad}  
          src={genre.image && genre.image !== '' ? genre.image : defaultAlbumImage} // Use normalized image URL or default
          alt={genre.name} 
          className="rounded-xl absolute h-[120%] min-h-[60px] aspect-square bottom-[-10px] right-[-10%] rotate-[20deg] shadow-2xl shadow-black/50 bg-black/50 transition-transform group-hover:rotate-[15deg] group-hover:scale-[1.05]" 
        />
      </div>
    </Link>
  )
