...
export const links = [
  { name: 'Home', to: '/', icon: AiOutlineHome, altIcon: AiFillHome, color: 'text-blue-400', bgFrom: 'from-blue-200', bgTo: 'to-blue-500' },
];
...
export const secondLinks = [
  ...
  // Removed 'Language' link from here, it remains in the footer
];
