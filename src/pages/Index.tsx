...
const Index = () => {
  ...
  return (
    <MainLayout>
      <div className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-black py-12 px-4">
        {/* Background Visuals */}
        ...
        <div className="relative z-10 max-w-5xl mx-auto w-full space-y-10">
          <div className="text-center space-y-4 animate-in fade-in slide-in-from-top-4 duration-700">
            ...
            <h1 className="text-4xl sm:text-6xl md:text-7xl font-black tracking-tighter leading-[0.9] text-white uppercase">
              EXPERIENCE <span className="text-zinc-600 italic">LIMITLESS</span>
            </h1>
            <p className="text-zinc-400 text-xs sm:text-sm max-w-md mx-auto font-bold uppercase tracking-widest leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 animate-in fade-in slide-in-from-bottom-6 duration-1000">
            {hubs.map((hub) => (
              <div
                ...
                className="group relative flex flex-col p-5 aspect-[4/5] rounded-[1.25rem] bg-zinc-900/40 border border-white/5 cursor-pointer transition-all duration-500 hover:bg-zinc-900/60 hover:-translate-y-2 hover:border-white/10 overflow-hidden shadow-2xl"
              >
                ...
                <div className="relative z-10 space-y-2.5">
                  <div className={`w-9 h-9 rounded-lg bg-white/5 flex items-center justify-center border border-white/10 ${hub.accent} transition-all duration-500 group-hover:scale-105 group-hover:bg-white/10`}>
                    <hub.icon size={18} />
                  </div>
                  <div>
